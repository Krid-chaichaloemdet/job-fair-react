...
export default function PositionData({
  ...
  return (
    <div
      className={`fixed inset-0 bg-[#131E3c] flex items-end z-50 duration-200 ease-in ${
        openModal ? "bg-opacity-50" : "bg-opacity-0"
      }`}
    >
      <div
        className={`bg-white rounded-t-[20px] w-full h-[80%] relative duration-300 flex flex-col justify-start transform ${
      ...
      >
        ...
        <div className="flex flex-col px-5 w-full h-[65%] overflow-y-scroll">
          ...
          <h3 className="font-bold text-[14px] py-2">Qualifications</h3>
          <ul className="list-disc text-[12px] pl-5">
